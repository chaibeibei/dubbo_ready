...
public class Article {
	...
	public Article(Integer id, String title, String content, String picture, Integer channel_id, Integer category_id,
			...
			Integer commentCnt, Integer tousuCnt, Integer reportCnt, String nickname) {
		super();
		this.id = id;
		this.title = title;
		this.content = content;
	...
	public String toString() {
		return "Article [id=" + id + ", title=" + title + ", content=" + content + ", picture=" + picture
				...
				+ ", updated=" + updated + ", commentCnt=" + commentCnt + ", tousuCnt=" + tousuCnt + ", reportCnt="
				+ reportCnt + ", nickname=" + nickname + "]";
	}
